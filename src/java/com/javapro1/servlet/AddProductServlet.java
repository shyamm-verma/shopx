...
public class AddProductServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Product pro = new Product(prodName,descp,price,image,category);
            
            ProdObj proObj = new ProdObj();
            boolean done = proObj.saveProductToDatabase(pro);
            ...
            e.printStackTrace();
            response.sendRedirect("addProduct.jsp?message=Error occurred while adding the product");
        }
    }
